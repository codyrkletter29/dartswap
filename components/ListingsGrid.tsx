      ...
      <div className="flex flex-wrap items-center gap-3 mb-6 pb-5 border-b border-border">
        ...
        <div className="relative">
          <select
            ...
            className={`appearance-none pl-4 pr-8 py-2 text-sm font-medium rounded-lg border transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary ${
              subcategoryFilter !== 'all'
          ...
          {/* Custom chevron */}
          <span className={`pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 ${subcategoryFilter !== 'all' ? 'text-white' : 'text-text-secondary'}`}>
        ...
        <div className="relative">
          ...
          {/* Custom chevron */}
          <span className={`pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 ${sizeFilter !== 'all' ? 'text-white' : 'text-text-secondary'}`}>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
              <path d="M2 4l4 4 4-4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </span>
